// classes do tipo repository são responsaveis por se
// conectarem com a fonte de dados, ex: banco de dados 
...
class ProductRepository{
  static List<Product> list(){
    return <Product>[
      ...
      Product(id: _uuid.v4(), name: "Abacaxi", price: 5.5, profit: 25, quantity: 50),
